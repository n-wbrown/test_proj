"""
Script for small utility functions used in test_proj
"""
############
# Standard #
############
...
def absolute_submodule_path(submodule, cur_dir=inspect.stack()[0][1]):
    """
    Returns the absolute path of the inputted test_proj submodule 
...
DIR_MODULE = Path(absolute_submodule_path("test_proj/"))
